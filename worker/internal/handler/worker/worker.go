...
import (
	"context"
	"gihub.com/mefourr/tgdevob/worker/internal/handler/idem"
...
func (rw *rqWorker) Process(ctx context.Context, msg *sarama.ConsumerMessage) error {
	...
	// TODO: cache user
	u, err := rw.client.LoadUser(ctx, m, strconv.FormatInt(m.User.ID, 10))
	if err != nil {
